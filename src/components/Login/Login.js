...
const Login = () => {
    ...
    const { signInUsingGoogle, user, loginUser, authError, loading } = useFirebase();
        ...
        <div>
            {
                loading ?
                    ...
                    <div className="conatiner mx-auto flex flex-col items-center justify-evenly mt-12">
                        ...
                        <h3 className="text-gray-900 font-medium font-poppins text-2xl">Log In</h3>
                        <form onSubmit={handleLoginSubmit}
                            className="w-3/12 flex flex-col items-center  h-36 mt-6 mb-5">
                        ...
                        <h3 className="text-gray-800 text-lg ">Don't have an account?
                            <NavLink to="/register">
